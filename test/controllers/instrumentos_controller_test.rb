...
class InstrumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrumento" do
    assert_difference('Instrumento.count') do
      post instrumentos_url, params: { instrumento: { aluno_id: @instrumento.aluno_id, nome: @instrumento.nome, professor_id: @instrumento.professor_id } }
    end
  ...
  test "should update instrumento" do
    patch instrumento_url(@instrumento), params: { instrumento: { aluno_id: @instrumento.aluno_id, nome: @instrumento.nome, professor_id: @instrumento.professor_id } }
