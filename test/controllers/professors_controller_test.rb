...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { cpf: @professor.cpf, identidade: @professor.identidade, instrumento: @professor.instrumento, nascimento: @professor.nascimento, nome: @professor.nome, salario: @professor.salario } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { cpf: @professor.cpf, identidade: @professor.identidade, instrumento: @professor.instrumento, nascimento: @professor.nascimento, nome: @professor.nome, salario: @professor.salario } }
